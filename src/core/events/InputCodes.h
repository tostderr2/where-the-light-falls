...
#define CORE_MOUSE_BUTTON_1         0
#define CORE_MOUSE_BUTTON_2         1
#define CORE_MOUSE_BUTTON_3         2
#define CORE_MOUSE_BUTTON_4         3
#define CORE_MOUSE_BUTTON_5         4
#define CORE_MOUSE_BUTTON_6         5
#define CORE_MOUSE_BUTTON_7         6
#define CORE_MOUSE_BUTTON_8         7
#define CORE_MOUSE_BUTTON_LAST      CORE_MOUSE_BUTTON_8
#define CORE_MOUSE_BUTTON_LEFT      CORE_MOUSE_BUTTON_1
#define CORE_MOUSE_BUTTON_RIGHT     CORE_MOUSE_BUTTON_2
#define CORE_MOUSE_BUTTON_MIDDLE    CORE_MOUSE_BUTTON_3
...
#define CORE_JOYSTICK_1             0
#define CORE_JOYSTICK_2             1
#define CORE_JOYSTICK_3             2
#define CORE_JOYSTICK_4             3
#define CORE_JOYSTICK_5             4
#define CORE_JOYSTICK_6             5
#define CORE_JOYSTICK_7             6
#define CORE_JOYSTICK_8             7
#define CORE_JOYSTICK_9             8
#define CORE_JOYSTICK_10            9
#define CORE_JOYSTICK_11            10
#define CORE_JOYSTICK_12            11
#define CORE_JOYSTICK_13            12
#define CORE_JOYSTICK_14            13
#define CORE_JOYSTICK_15            14
#define CORE_JOYSTICK_16            15
#define CORE_JOYSTICK_LAST          CORE_JOYSTICK_16


#define CORE_GAMEPAD_BUTTON_A               0
#define CORE_GAMEPAD_BUTTON_B               1
#define CORE_GAMEPAD_BUTTON_X               2
#define CORE_GAMEPAD_BUTTON_Y               3
#define CORE_GAMEPAD_BUTTON_LEFT_BUMPER     4
#define CORE_GAMEPAD_BUTTON_RIGHT_BUMPER    5
#define CORE_GAMEPAD_BUTTON_BACK            6
#define CORE_GAMEPAD_BUTTON_START           7
#define CORE_GAMEPAD_BUTTON_GUIDE           8
#define CORE_GAMEPAD_BUTTON_LEFT_THUMB      9
#define CORE_GAMEPAD_BUTTON_RIGHT_THUMB     10
#define CORE_GAMEPAD_BUTTON_DPAD_UP         11
#define CORE_GAMEPAD_BUTTON_DPAD_RIGHT      12
#define CORE_GAMEPAD_BUTTON_DPAD_DOWN       13
#define CORE_GAMEPAD_BUTTON_DPAD_LEFT       14
#define CORE_GAMEPAD_BUTTON_LAST            CORE_GAMEPAD_BUTTON_DPAD_LEFT

#define CORE_GAMEPAD_BUTTON_CROSS       CORE_GAMEPAD_BUTTON_A
#define CORE_GAMEPAD_BUTTON_CIRCLE      CORE_GAMEPAD_BUTTON_B
#define CORE_GAMEPAD_BUTTON_SQUARE      CORE_GAMEPAD_BUTTON_X
#define CORE_GAMEPAD_BUTTON_TRIANGLE    CORE_GAMEPAD_BUTTON_Y

#define CORE_GAMEPAD_AXIS_LEFT_X        0
#define CORE_GAMEPAD_AXIS_LEFT_Y        1
#define CORE_GAMEPAD_AXIS_RIGHT_X       2
#define CORE_GAMEPAD_AXIS_RIGHT_Y       3
#define CORE_GAMEPAD_AXIS_LEFT_TRIGGER  4
#define CORE_GAMEPAD_AXIS_RIGHT_TRIGGER 5
#define CORE_GAMEPAD_AXIS_LAST          CORE_GAMEPAD_AXIS_RIGHT_TRIGGER
